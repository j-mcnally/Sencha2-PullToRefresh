...
Ext.define("Ext.ux.kohactive.RefreshableList", {
    ...
    alias:"widget.RefreshableList",
     ...
     resetPulldown: function(offset) {
           ...
           this.loading = false;
           if (this.prevState == 1){
           Ext.Anim.run(this.pullEl.down('.arrow'),'rotate',{dir:'cw',fromAngle:180,toAngle:0});
           }
     },
     ...
     this.pullEl = this.pullTpl.applyTemplate({h:0,m:this.langPullRefresh,l:this.lastUpdate}, true);
     ...
     Ext.Anim.run(this.pullEl.down('.arrow'),'rotate',{dir:'ccw',fromAngle:0,toAngle:180});
     }
